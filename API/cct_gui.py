...
def extract_cct_from_colorbar(image_path):
    ...
    color_bar = image[50:200, 20:50]  # Adjust coordinates for your image
    if color_bar.size == 0:
    ...
    central_region = image[100:150, 120:170]  # Adjust coordinates for your image
...
class CCTCalculatorApp(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("CCT Calculator")
